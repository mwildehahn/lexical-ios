  ...
  throws
{
  ...
  let oldRange = editor.featureFlags.optimizedReconciler ? rangeCacheItem.textRangeFromFenwick(using: editor.fenwickTree, leadingShift: false, rangeCache: editor.rangeCache) : rangeCacheItem.textRange
