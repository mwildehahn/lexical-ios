  ...
  throws
{
  ...
  let oldRange = editor.featureFlags.optimizedReconciler ? rangeCacheItem.textRangeFromFenwick(using: editor.fenwickTree, leadingShift: editor.featureFlags.leadingNewlineBaselineShift, rangeCache: editor.rangeCache) : rangeCacheItem.textRange
